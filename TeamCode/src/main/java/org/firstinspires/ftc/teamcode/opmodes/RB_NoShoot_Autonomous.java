...
@Autonomous(name="Right Blue NO SHOOT Auto", group="Linear Opmode")
public class RB_NoShoot_Autonomous extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        Operation[] operations = {
                moveToShoot, dropWobble, raiseWobble, stopWobble,park
        };
